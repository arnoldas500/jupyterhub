...
c.Authenticator.whitelist = {'xcite', 'arnoldas500', 'wmay'}
# set of users who can administer the Hub itself
c.Authenticator.admin_users = {'xcite','arnoldas500'}

'''
c.JupyterHub.authenticator_class = 'oauthenticator.GitHubOAuthenticator'
c.GitHubOAuthenticator.oauth_callback_url = os.environ['https://weather.asrc.albany.edu/hub/oauth_callback']
...
#c.JupyterHub.data_files_path = '/home/xcite/miniconda3/share/jupyter/hub'
